...
# 编写仪表盘代码（使用 yida-canvas-custom-page 或 yida-custom-page 技能）
# 源码推荐保存为 project/pages/src/ipd-dashboard.oyd.jsx
openyida check-page project/pages/src/ipd-dashboard.oyd.jsx
openyida compile project/pages/src/ipd-dashboard.oyd.jsx
openyida publish project/pages/src/ipd-dashboard.oyd.jsx <appType> <formUuid>
*/
...
# 4. 编写并发布仪表盘（使用 custom-page-template 模板，源码为 .oyd.jsx）
openyida check-page project/pages/src/ipd-dashboard.oyd.jsx
openyida compile project/pages/src/ipd-dashboard.oyd.jsx
openyida publish project/pages/src/ipd-dashboard.oyd.jsx <appType> <formUuid>
