  ...
  return {
    ...
    core_workflows: {
      full_app_fast_build: {
        ...
        ui_guidance_policy: 'Before writing the primary page in fast_build, load yida-page-uiux as lightweight UI guidance to decide page type, template route, visualProfile, and sample-avoidance checks. This is not deep_design and must not pull yida-app-uiux, theme, navigation, demo data, screenshots, or long PRD work by default.',
