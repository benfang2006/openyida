  ...
  return {
    ...
    core_workflows: {
      full_app_build: {
        ...
        form_visual_guidance_policy: 'Default form page development loads yida-form-detail as form visual guidance, merges Divider semantic grouping into field JSON, and only injects formDetail CSS when the user or PRD requires detail-page styling after a real formUuid exists.',
