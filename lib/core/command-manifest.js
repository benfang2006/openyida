  ...
  return {
    ...
    core_workflows: {
      full_app_build: {
        ...
        product_design_policy: 'Full app creation first resolves resource context, then uses yida-design for requirement analysis and product design before creating or filling missing app/form/process/page resources. yida-design outputs prd/<project>.md with basic app information, app configuration, data structures, page functions, visual specification, theme color, per-page layouts, business rules, interaction states, resource blueprint, resource creation order, page implementation delivery order, navigation order, and acceptance criteria.',
        ui_guidance_policy: 'Default full-app primary page creation consumes the yida-design PRD for positioning, theme system, information architecture, page prototype, visual states, material strategy, native form entry policy, and business-specific checks. Page implementation extracts page-spec.json from the PRD. Demo data, screenshots, public sharing, data-source deep binding, and fine navigation grouping are optional after explicit user request or PRD acceptance criteria.',
