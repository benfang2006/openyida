...
`,
  ...
  copy: {
    ...
    no_ai_tool: '\n❌ 未检测到活跃的 AI 工具环境\n   支持的工具：Codex、OpenCode、Claude Code、Aone Copilot、Cursor、QwenWork（千问办公）、QoderWork、Qoder\n\n   当前检测结果：',
    no_active_tool: '\n❌ 未检测到活跃的 AI 工具环境',
    supported_tools: '   支持的工具：Codex、OpenCode、Claude Code、Aone Copilot、Cursor、QwenWork（千问办公）、QoderWork、Qoder',
    current_result: '\n   当前检测结果：',
    force_hint: '\n   如需强制复制到当前目录，请运行：\n   openyida copy --force',
