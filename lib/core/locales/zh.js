...
`,
  ...
  publish: {
    ...
    lint_canvas_yida_api_bridge_missing: 'Code Canvas 表单数据读取必须优先消费 window.__OPENYIDA_YIDA_API__（发布层由外层 didMount 注入 this.utils.yida 桥）；不要默认手写内部 searchFormDatas fetch',
