...
`,
    ...
    update_app_usage: '用法: openyida update-app <appType> [--name "新名称"] [--desc "描述"] [--icon "图标"] [--hide-app-nav|--show-app-nav]',
    update_app_example: '示例: openyida update-app APP_XXX --name "新应用名称" --desc "新描述"；openyida update-app APP_XXX --hide-app-nav',
  ...
  // ── lib/update-app.js ─────────────────────────────
  update_app: {
    usage: '用法: openyida update-app <appType> [--name "新名称"] [--desc "描述"] [--layout slide|ver] [--theme deepBlue] [--hide-app-nav|--show-app-nav]',
    example: '示例: openyida update-app APP_XXX --name "新应用名称" --layout ver --theme deepBlue；页面内自绘导航时: openyida update-app APP_XXX --hide-app-nav',
    ...
    missing_update_field: '错误: 至少需要指定一个更新字段（--name, --desc, --icon, --theme, --nav-theme, --layout, --hide-app-nav, --show-app-nav）',
