...
Commands:
  ...
  create-app --name "<name>" [--theme-file <css> and nav options] Create an app; modern theme recommended, output appType
...
Examples:
  openyida login
  openyida logout
  openyida create-app --name "Attendance" --theme-file ./app-theme.css --nav-theme light --logo-source appIcon --layout l_shape
...
`,
  ...
  create_app: {
    ...
    usage: 'Usage: openyida create-app "<appName>" [description] [icon] [iconColor] [theme] or openyida create-app --name "<appName>" [--theme-file ./app-theme.css --nav-theme light|dark|white|gray --logo-source appIcon --layout side|top|l_shape]',
    example: 'Example: openyida create-app --name "Attendance" --desc "Employee attendance system" --theme-file ./app-theme.css --nav-theme light --logo-source appIcon --layout l_shape',
    available_icons: '\nAvailable icons:',
