...
`,
    ...
    update_app_usage: 'Usage: openyida update-app <appType> [--name "New Name"] [--desc "Description"] [--icon "icon-name"] [--hide-app-nav|--show-app-nav]',
    update_app_example: 'Example: openyida update-app APP_XXX --name "New App Name" --desc "New Description"; openyida update-app APP_XXX --hide-app-nav',
    ...
    first_run_footer1: '  Supported AI tools: Codex / Claude Code / Aone Copilot / Cursor / OpenCode / QwenWork',
  ...
  create_page: {
    ...
    example: 'Example: openyida create-page "APP_XXX" "Game Home" --mode dashboard; explicitly hide nav: openyida create-page "APP_XXX" "Fullscreen Dashboard" --mode dashboard --hide-nav',
    app_id: '  App ID:    {0}',
  ...
  // ── lib/update-app.js ─────────────────────────────
  update_app: {
    usage: 'Usage: openyida update-app <appType> [--name "New Name"] [--desc "Description"] [--layout slide|ver] [--theme deepBlue] [--hide-app-nav|--show-app-nav]',
    example: 'Example: openyida update-app APP_XXX --name "New App Name" --layout ver --theme deepBlue; page shell nav: openyida update-app APP_XXX --hide-app-nav',
    ...
    missing_update_field: 'Error: at least one update field must be specified (--name, --desc, --icon, --theme, --nav-theme, --layout, --hide-app-nav, --show-app-nav)',
  ...
  copy: {
    ...
    no_ai_tool: '\n❌ No active AI tool environment detected\n   Supported tools: Wukong, Codex, OpenCode, Claude Code, Aone Copilot, Cursor, QwenWork, QoderWork, Qoder\n\n   Current detection results:',
    no_active_tool: '\n❌ No active AI tool environment detected',
    supported_tools: '   Supported tools: Wukong, Codex, OpenCode, Claude Code, Aone Copilot, Cursor, QwenWork, QoderWork, Qoder',
    current_result: '\n   Current detection results:',
