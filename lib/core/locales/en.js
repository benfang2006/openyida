...
module.exports = {
  ...
  help: {
    ...
    cmd_generate_page: 'Generate a page skeleton from a built-in sample',
...
`,
    ...
    compile_example: 'Example: openyida compile pages/src/home.canvas.jsx',
    ...
    generate_page_usage: 'Usage: openyida generate-sample <sample> --output pages/src/home.canvas.jsx [--spec .cache/openyida/page-specs/home.json] [--theme-scope page|app] [--compile]',
    generate_page_example: 'Example: openyida generate-sample product-homepage --brand-name OpenKuma --brand-initials OK --theme-scope page --output pages/src/home.canvas.jsx --compile',
  ...
  publish: {
    ...
    lint_form_open_container: 'When opening Yida form submission/detail pages from a custom page, use a FormOpenContainer drawer iframe on desktop and only open a full/new page on mobile.',
