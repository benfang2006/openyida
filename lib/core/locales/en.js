...
`,
  ...
  publish: {
    ...
    lint_canvas_yida_api_bridge_missing: 'Code Canvas form data reads must consume window.__OPENYIDA_YIDA_API__ first (the publish layer injects the this.utils.yida bridge from outer didMount); do not default to handwritten internal searchFormDatas fetch',
