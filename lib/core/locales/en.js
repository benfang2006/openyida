...
`,
  ...
  login: {
    ...
    oauth_success_message: 'Authentication is complete. You can return to the terminal and continue using OpenYida.',
    oauth_closing: 'Closing this window automatically…',
    oauth_manual_close: 'Window still open? Close it manually, then return to the terminal.',
