...
module.exports = {
  ...
  publish: {
    ...
    lint_native_select_ui: 'Phát hiện <select> native. Trong trang tùy chỉnh bằng code, bạn có thể dùng trực tiếp component Yida <SelectField> (được inject global lúc runtime, không cần import), hoặc dùng dropdown tùy chỉnh div+button+onClick để giữ style nhất quán và tương thích mobile',
