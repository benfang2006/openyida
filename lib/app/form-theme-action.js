...
function buildYidaThemeActionSource(previousActionName, formDetailCss) {
...
function openyidaThemeInjectGlobal(doc) {
  ...
  var themeConfig = openyidaThemeBuildVariables(openyidaThemeResolveColor(doc));
...
function ensureYidaGlobalThemeAction(schema, options = {}) {
  ...
  const generatedSource = buildYidaThemeActionSource(previousActionName, formDetailCss || '');
