...
description: 配置已有流程表单审批规则。
---

# 宜搭流程规则配置技能

> 资源边界：本技能只处理普通 OpenYida 流程规则配置；目标不明时先只读确认或询问用户。
...
| 3 | **本技能** | 配置表单的流程规则 |
| 4 | `yida-canvas-custom-page` / `yida-custom-page` | 编写自定义页面代码；历史 JSX 页面维护才使用 `yida-custom-page` |
