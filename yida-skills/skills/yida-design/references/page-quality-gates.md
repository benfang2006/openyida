...
- 应用主题设计必须写清 CSS 模板、产物路径、平台实际生成的完整 `--color-brand1-1/2/3/5/6/9/10` 色阶、`--color-brand1-6` 字面量主色，以及 `--theme-file/--nav-theme/--logo-source/--layout` 联合保存方案；不得补造 `--color-brand1-4/7/8`。
